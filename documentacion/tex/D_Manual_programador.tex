...
\imagen{conexionPickit}{\emph{Pinout} del \emph{PICKit3}.}
...
\imagen{pickit3}{Configuración avanzada de \emph{MPLAB}.}
...
\imagen{mphidflash}{Salida del comando \emph{mphidflash}.}
